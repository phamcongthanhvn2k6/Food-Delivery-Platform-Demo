    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="max-w-4xl w-full bg-white rounded-3xl shadow-xl overflow-hidden flex flex-col md:flex-row">
        ...
        <div className="md:w-1/2 p-8 md:p-12 flex flex-col pt-12">
          ...
          {message && <div className="mb-4 text-green-600 text-sm bg-green-50 p-3 rounded-lg border border-green-100">{message}</div>}
          ...
          <form onSubmit={handleResetPassword} className="space-y-6">
            ...
            <button 
              type="submit" 
              disabled={loading}
              className="w-full bg-[#0052cc] text-white py-3.5 rounded-xl font-bold text-[15px] hover:bg-blue-700 hover:shadow-lg hover:-translate-y-0.5 transform transition-all flex justify-center items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
