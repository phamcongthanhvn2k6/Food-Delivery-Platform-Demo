      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-6 py-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-10 gap-6">
           <div>
              ...
              <p className="text-gray-500 font-medium">Premium culinary experiences, delivered with precision and exceptional value.</p>
           </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6 mb-12">
            ...
            <div className="lg:col-span-2 relative bg-gray-900 rounded-[32px] overflow-hidden shadow-md flex items-center min-h-[280px]">
               ...
               <div className="absolute inset-0 bg-gradient-to-r from-[#003d99]/90 to-transparent"></div>
               ...
               <div className="relative z-10 p-10 md:p-12 max-w-md">
                  ...
                  <p className="text-blue-100 mb-8 font-medium">Enjoy 50% OFF at all signature Michelin-star partners this weekend.</p>
            ...
            <div className="bg-gradient-to-br from-[#c4d2ff] to-[#e4eaff] rounded-[32px] p-8 md:p-10 shadow-sm flex flex-col justify-between border border-white min-h-[280px]">
               <div>
                  <h3 className="text-xl font-extrabold text-gray-900 mb-2">Kinetic Gold Status</h3>
                  <p className="text-sm text-gray-600 font-medium">Your exclusive pass to unlimited free delivery across all elite restaurants.</p>
               </div>
               
               <div className="mt-8">
                  <div className="text-3xl font-extrabold text-[#003d99] mb-4">FREE <span className="text-sm font-medium text-gray-500">for 30 days</span></div>
        ...
        <div className="mb-14">
           ...
           <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
               ...
               <div className="bg-white rounded-[24px] shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition">
                  <div className="bg-[#0f172a] text-white h-24 flex flex-col items-center justify-center relative overflow-hidden">
                     ...
                     <span className="text-[10px] tracking-widest opacity-80 font-medium relative z-10">PREMIUM ORDER ONLY</span>
                  </div>
                  <div className="p-6">
               ...
               {/* Voucher 2 */}
               <div className="bg-white rounded-[24px] shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition">
                  <div className="bg-orange-50 text-orange-600 h-24 flex flex-col items-center justify-center relative border-b border-orange-100">
                     <span className="text-2xl font-extrabold relative z-10">30% OFF</span>
                     <span className="text-[10px] tracking-widest opacity-80 font-medium relative z-10">UP TO 100K DISCOUNT</span>
                  </div>
                  <div className="p-6">
                     <div className="flex items-center gap-3 mb-6">
               ...
               {/* Voucher 3 */}
               <div className="bg-white rounded-[24px] shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition">
                  <div className="bg-gradient-to-r from-purple-500 to-pink-500 text-white h-24 flex flex-col items-center justify-center relative">
                     <span className="text-2xl font-extrabold relative z-10">FREE DELIV</span>
                     <span className="text-[10px] tracking-widest opacity-90 font-medium relative z-10">NO MIN VALUE REQ</span>
                  </div>
                  <div className="p-6">
                     <div className="flex items-center gap-3 mb-6">
               ...
               {/* Voucher 4 */}
               <div className="bg-white rounded-[24px] shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition">
                  <div className="bg-[#0052cc] text-white h-24 flex flex-col items-center justify-center relative">
                     <span className="text-2xl font-extrabold relative z-10">100k OFF</span>
                     <span className="text-[10px] tracking-widest opacity-80 font-medium relative z-10">FIRST PREMIUM ORDER</span>
                  </div>
                  <div className="p-6">
                     <div className="flex items-center gap-3 mb-6">
                        <div className="w-8 h-8 rounded-full bg-blue-50 text-[#0052cc] font-bold text-xs flex items-center justify-center border border-blue-100">KC</div>
                        <div>
               ...
               {/* Voucher BOGO */}
               <div className="bg-white rounded-[24px] shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition">
                  <div className="bg-green-50 text-green-700 h-24 flex flex-col items-center justify-center relative border-b border-green-100">
                     <span className="text-2xl font-extrabold relative z-10">BOGO</span>
                     <span className="text-[10px] tracking-widest opacity-80 font-medium relative z-10">BUY ONE GET ONE FREE</span>
                  </div>
                  <div className="p-6">
                     <div className="flex items-center gap-3 mb-6">
                        <div className="w-8 h-8 rounded-full bg-green-50 text-green-700 font-bold text-xs flex items-center justify-center border border-green-100">SK</div>
                        <div>
               ...
               <div className="bg-gray-50 rounded-[24px] shadow-none border border-gray-200 overflow-hidden opacity-70">
                  <div className="bg-gray-100 text-gray-400 h-24 flex flex-col items-center justify-center relative border-b border-gray-200">
                     <span className="text-2xl font-extrabold relative z-10">EXPIRED</span>
                     <span className="text-[10px] tracking-widest opacity-80 font-medium relative z-10">SEASONAL BONUS</span>
                  </div>
                  <div className="p-6">
